            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!--INPUT DEL CAMPO NOMBRE-->
                            <div class="form-group <?php echo form_error("nombre") != false? 'has-error':''?>">
                                <label for="nombre">Nombre:</label>
                                <input type="text" class="form-control" id="nombre" name="nombre" 
                                value="<?php echo form_error("nombre") !=false ? set_value("nombre") : $cliente->nombre;?>">
                                <?php echo form_error("nombre","<span class='help-block'>","</span>");?>
                            </div>


                        <!--INPUT DEL CAMPO TIPO DE CLIENTE-->
                                ...
                                <select name="tipocliente" id="tipocliente" class="form-control">
                                    ...
                                    <?php if(form_error("tipocliente")!=false || set_value("tipocliente")!=false):?>
                                                <?php foreach ($tipoclientes as $tipocliente) :?>
                                                    <option value="<?php echo $tipocliente->id;?>"<?php echo set_select("tipocliente",$tipocliente->id);?>>
                                                    <?php echo $tipocliente->nombre ?></option>
                                                <?php endforeach;?>
                                    <?php else:?>
                                                <?php foreach ($tipoclientes as $tipocliente) :?>
                                                    <option value="<?php echo $tipocliente->id;?>"<?php echo $tipocliente->id == $cliente->tipo_cliente_id ? 'selected' : '';?>>
                                                    <?php echo $tipocliente->nombre ?></option>
                                                <?php endforeach;?> 
                                    <?php endif?>
                                </select>
                        ...
                        <!--INPUT DEL CAMPO TIPO DE DOCUMENTO-->
                                ...
                                <select name="tipodocumento" id="tipodocumento" class="form-control">
                                    ...
                                    <?php if(form_error("tipodocumento")!=false || set_value("tipodocumento")!=false):?>
                                                <?php foreach ($tipodocumentos as $tipodocumento) :?>
                                                    <option value="<?php echo $tipodocumento->id;?>"<?php echo set_select("tipodocumento",$tipodocumento->id);?>>
                                                    <?php echo $tipodocumento->nombre ?></option>
                                                <?php endforeach;?>
                                    <?php else:?>
                                                <?php foreach ($tipodocumentos as $tipodocumento) :?>
                                                    <option value="<?php echo $tipodocumento->id;?>"<?php echo $tipodocumento->id == $cliente->tipo_documento_id ? 'selected' : '';?>>
                                                    <?php echo $tipodocumento->nombre ?></option>
                                                <?php endforeach;?> 
                                    <?php endif?>
                                </select>
                        ...
                        <!--INPUT DEL CAMPO NUMERO DOCUMENTO-->
                            <div class="form-group <?php echo form_error("numero") != false? 'has-error':'';?>">
                                <label for="numero">Numero del Documento:</label>
                                <input type="text" class="form-control" id="numero" name="numero" value="<?php echo form_error("numero") !=false ? set_value("numerp") : $cliente->num_documento;?>">
